...
#Secure this data :)
from configdb import EMAIL, PASSWORD, DIR , APIKEY ,SSH_PASSWORD, SSH_USERNAME, DATABASE_PASSWORD, DATABASE_USERNAME, SSH_HOST, DBNAME
...
def send_email(subject, sender, date, to_email):
    ...
    try:
        ...
        msg['From'] = from_email
        msg['To'] = to_email
        msg['Subject'] = "This offer should be checked manually"
